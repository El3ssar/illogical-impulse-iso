...
| **Control Center GUI** | the standalone panel; panes shell out to iictl | baked | `control/` under the welcome dir family; `iictl center` (`qs -p`) | — | L | must |
